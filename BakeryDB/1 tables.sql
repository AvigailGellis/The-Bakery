...
create table dbo.Orders(
    ...
    PricePerUnit decimal(6,2) not null constraint ck_Orders_PricePerUnit_must_be_between_2_dollars_and_50_cents_and_650_dollars check(PricePerUnit between 2.5 and 650),
    ...
    CreditCardNum char(4) not null constraint ck_Orders_CreditCardNum_must_be_numbers check(CreditCardNum like ('[0-9][0-9][0-9][0-9]') or CreditCardNum = ''),
    ...
    constraint ck_Orders_DateOrdered_must_be_before_DateNeeded check(DateOrdered < DateNeeded),
